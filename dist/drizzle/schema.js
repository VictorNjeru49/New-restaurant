...
exports.authorityownertable = (0, pg_core_1.pgTable)("authorityowner", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    ownerId: (0, pg_core_1.integer)("user_id").notNull().references(() => restaurant_ownertable.id),
    password: (0, pg_core_1.varchar)("password", { length: 100 }),
    ownersname: (0, pg_core_1.varchar)("username", { length: 100 }),
    role: (0, exports.roleEnum)("role").default("restaurant_owner")
});
//relationships
...
exports.driverrelations = (0, drizzle_orm_1.relations)(exports.authoritydrivertable, ({ one }) => ({
    driver: one(drivertable, {
        fields: [exports.authoritydrivertable.driverId],
        references: [drivertable.id]
    })
}));
exports.ownerrelations = (0, drizzle_orm_1.relations)(exports.authorityownertable, ({ one }) => ({
    owner: one(restaurant_ownertable, {
        fields: [exports.authorityownertable.ownerId],
        references: [restaurant_ownertable.id]
    })
}));
