...
exports.registerownerUser = exports.registerdriverUser = exports.loginUser = exports.registerUser = void 0;
...
const registerownerUser = async (c) => {
    try {
        const owner = await c.req.json();
        const pass = owner.password;
        const hashedPassword = await bcrypt_1.default.hash(pass, 10);
        owner.password = hashedPassword;
        const createdUser = await (0, authentication_service_1.ownerService)(owner);
        if (!createdUser)
            return c.text("User not created", 404);
        return c.json({ message: createdUser }, 201);
    }
...
exports.registerownerUser = registerownerUser;
