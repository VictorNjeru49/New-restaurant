...
exports.authorityrelationship.post('/ownership', (0, zod_validator_1.zValidator)('json', validators_1.ownershipvalidator, (result, c) => {
    if (!result.success) {
        return c.json(result.error, 400);
    }
}), authentication_contoller_1.registerownerUser);
