...
exports.ownerService = exports.createownerservice = exports.driverLoginService = exports.createdriverService = exports.userLoginService = exports.createauthorityService = void 0;
...
const ownerService = async (owner) => {
    const ownersname = owner;
    return await db_1.default.query.authorityownertable.findFirst({
        columns: {
            ownersname: true,
            role: true,
            password: true
        }, where: (0, drizzle_orm_1.sql) ` ${schema_1.authorityownertable.ownersname} = ${ownersname}`,
        with: {
            owner: {
                columns: {
                    id: true,
